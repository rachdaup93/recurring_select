...
Gem::Specification.new do |s|
  s.name        = "recurring_select_fix_v1_2_0"
  s.version     = RecurringSelect::VERSION
  s.authors     = ["Jobber", "Forrest Zeisler", "Nathan Youngman", "Rachelle Dauphin"]
  s.email       = ["rachdaup.tech@gmail.com"]
  s.homepage    = "http://github.com/rachdaup93/recurring_select"
